...
public class COWIN 
{
    ...
    static class add_vaccine
    {
        ...
        public HashMap <String, Integer> vacc_numb = new HashMap<>();aimport java.util.*;
    ...
    static class SLOT
    {
        ...
        public void book_slot()
        {
            ...
            switch(ch)
            {
                ...
                for(HashMap.Entry <Integer, ArrayList> trav : add_hospital.hospital_pc.entrySet()) 
                {
                    {   
                ...
                dets = hos_deets.get(id);

                int slot_no = dets.get(0)-1;
